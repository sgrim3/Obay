...
define([
  ...
  var AddListingView = DestroyableView.extend({
    ...
    destroy:function () {
      /*This is rewritten so that dropzone instances are automatically 
      destroyed! Destroy dropzone instance to prevent memory leaks.*/
      Dropzone.instances = _.without(Dropzone.instances, 
        this.image_upload);
    ...
    render:function (info) {
      ...
      var dropzone_options = {
        dictDefaultMessage: 'Click to upload to Imgur! ' 
        ...
        init: function() {
          this.on("addedfile", function() {
            ...
            $('#image_upload').append("<button class='round-button' " 
              + "id='deleteImageButton'><i class='fa fa-times'></i></button>");
      ...
      this.image_upload = new Dropzone($('#image_upload')
        .get(0), dropzone_options);
    ...
    postHelper: function postHelper(event, onSuccess, onErr) {
    ...
    postListing: function postListing(event) {
